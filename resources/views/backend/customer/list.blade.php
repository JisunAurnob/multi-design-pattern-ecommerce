...
<div class="container flex flex-col px-8">
    ...
    <div class="flex items-center justify-between px-9">
        ...
        <div>
            <form action="{{route('customer.list')}}" method="get" class="w-full">
                <div class="flex items-center justify-center mb-10">
                    ...
                    <div class="mt-1.5">
                        ...
                        <a href="{{ route('customer.list') }}" class="focus:outline-none space-x-6 bg-red-500 text-white rounded-md px-4 py-2.5 ml-5 mt-5">
                            Reset
                        </a>
                        
                        @endif

                        <a href="{{ route('customer.export') }}" class="focus:outline-none space-x-6 bg-green-500 text-white rounded-md px-4 py-2.5 ml-5 mt-5">
                            Export
                        </a>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="text-sm text-gray-900">
                            <div class="ml-4">
                                <div class="text-sm font-medium text-gray-900">
                                    ...
                                    <img width="150 px" src=" {{$customer->image}}" class=" object-contain rounded-full h-14 w-14" alt="">
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="flex px-8 py-8 space-x-2 text-sm font-medium text-right whitespace-nowrap">
                            <a title="Profile" href="{{route('customer.view',$customer->id)}}" class="text-indigo-600 hover:text-indigo-900">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                                    <path fill="none" d="M0 0h24v24H0z" />
                                    <path d="M12 3c5.392 0 9.878 3.88 10.819 9-.94 5.12-5.427 9-10.819 9-5.392 0-9.878-3.88-10.819-9C2.121 6.88 6.608 3 12 3zm0 16a9.005 9.005 0 0 0 8.777-7 9.005 9.005 0 0 0-17.554 0A9.005 9.005 0 0 0 12 19zm0-2.5a4.5 4.5 0 1 1 0-9 4.5 4.5 0 0 1 0 9zm0-2a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z" />
                                </svg>
                            </a>
                            <a title="Edit" href="{{route('customer.edit',$customer->id)}}" class="text-indigo-600 hover:text-indigo-900">
                                <svg class="w-5 h-5 text-blue-600" viewBox="0 0 20 20" fill="currentColor">
                                    <path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z" />
                                    <path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd" />
                                </svg>
                            </a>
                            <a title="Delete" href="{{route('customer.delete',$customer->id)}}" onclick="return confirm('Are you sure you want to delete it ?')" class="text-indigo-600 hover:text-indigo-900">
