...
@section('main')
    ...
    <form id="product_form" action="{{ route('admin.product.store') }}" method="post" class=" px-6 py-6 rounded-md space-y-7"
        ...
        <div class="bg-white py-12 rounded-lg shadow-md">
            ...
            <div class="px-10">
                ...
                <div class="mt-1 relative rounded-md shadow-sm">
                    <textarea id="short_description" value="{{ old('short_description') }}" name="short_description"
                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:ring-2 focus:border-blue-200 focus:outline-none"
            ...
            <div class="px-10">
                ...
                <div class="mt-1 relative rounded-md shadow-sm">
                    <textarea id="long_description" value="{{ old('long_description') }}" name="long_description" type="text"
            ...
            <div class="px-10">
                ...
                <div class="mt-1 relative rounded-md shadow-sm">
                    <input id="price" value="{{ old('price') }}" name="price" type="number"
                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:ring-2 focus:border-blue-200 focus:outline-none"
            ...
            <div class="px-10">
                ...
                <div class="mt-1 relative rounded-md shadow-sm">
                    <input id="quantity" value="{{ old('quantity') }}" name="quantity" type="number"
                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:ring-2 focus:border-blue-200 focus:outline-none"
            ...
            <div class="px-10">
                ...
                <div class="mt-1 relative rounded-md shadow-sm">
                    <input id="discount" value="{{ old('discount') }}" name="discount" type="number"
                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:ring-2 focus:border-blue-200 focus:outline-none"
            ...
            <div class="px-10">
                ...
                <div class="mt-1 relative rounded-md shadow-sm">
                    <select required name="category_id" id="single"
                        class=" form-select appearance-none
                            block
                            w-full
                            px-3
            ...
            <div class="px-10">
                ...
                <div class="mt-1 relative rounded-md shadow-sm">
                    <input id="meta_title" value="{{ old('meta_title') }}" name="meta_title" type="text"
                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:ring-2 focus:border-blue-200 focus:outline-none"
            ...
            <div class="px-10">
                ...
                <div class="mt-1 relative rounded-md shadow-sm">
                    <textarea id="meta_description" value="{{ old('meta_description') }}" name="meta_description" type="text"
                        class="ckeditor form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:ring-2 focus:border-blue-200 focus:outline-none"
            ...
            <div class="px-10">
                ...
                <div class="mt-1 relative rounded-md shadow-sm">
                    <input id="min_order_quantity" value="{{ old('min_order_quantity') }}" name="min_order_quantity"
                        type="number"
                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:ring-2 focus:border-blue-200 focus:outline-none"
            ...
            <div class="px-10">
                ...
                <div class="mt-1 relative rounded-md shadow-sm">
                    <input id="max_order_quantity" value="{{ old('max_order_quantity') }}" name="max_order_quantity"
                        type="number"
                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:ring-2 focus:border-blue-200 focus:outline-none"
            ...
            <div class="my-4 px-10">
                ...
                <main class="container mx-auto max-w-screen-lg h-full" id="multi_image_upload_div">
                    <!-- file upload modal -->
...
@push('js')
    <script>
        ...
        document.getElementById("submit").onclick = (event) => {
            ...
            var url = document.getElementById("product_form").action;
            ...
            // var editor = ClassicEditor.instances['long_description'];
                    ...
                    if (response?.validation_error) {
                        ...
                        Object.entries(response.validation_error).forEach(([field_name, error]) => {
                            ...
                            if (keys.length > 1) {
                                ...
                                if(field_name=='multiple_images'){
                                const parentElement = document.getElementById('multi_image_upload_div');
                                    const errorElement = document.createElement('span');
                                    errorElement.className = "font-bold text-red-600 mb-4 validation-error";
                                    errorElement.textContent = error;
