...
<div class="flex items-center justify-center">
  <div class="p-4 rounded w-full">
    <div class="md:grid md:grid-cols-3 md:gap-4 lg:grid-cols-3 space-y-4 md:space-y-0 mt-4 lg:gap-8">
        ...
        <div class="shadow-md bg-white rounded-lg h-36">
          <div class="flex items-center justify-between  p-8">
            ...
            <div class="p-4 bg-purple-600 text-white rounded-full">
              <svg xmlns="http://www.w3.org/2000/svg" class="fill-current w-7 h-7" width="24" height="24" viewBox="0 0 24 24">
        ...
        <div class="shadow-md bg-white rounded-lg h-36">
          <div class="flex items-center justify-between  p-8">
            ...
            <div class="p-4 bg-green-600 text-white rounded-full">
              <svg class="fill-current w-7 h-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
      ...
      <a href="{{ route('order.list', ['status' => 'pending']) }}">
        <div class="shadow-md bg-white rounded-lg h-36">
          <div class="flex items-center justify-between  p-6">

            <div class="space-y-4">
              <p class="text-gray-500 text-xl font-semibold">Pending Orders</p>
              <div class="flex items-baseline space-x-4">
                <h2 class="text-2xl font-semibold">
                  {{$data['pending_order']}}
                </h2>
