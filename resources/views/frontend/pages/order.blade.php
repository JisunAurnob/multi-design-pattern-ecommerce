...
<div class="container mt-12">
    <div class="w-full flex px-10 space-x-7">
        ...
        <div class="w-full tab-content">
            <div class="px-5 active" id="dashboard" data-tab-content="">
                <div class="bg-white rounded-xl py-4 px-6 border-b-4 border-darkred-50 mb-4">
                    <h1 class="capitalize">dashboard</h1>
                </div>
                <div class="grid grid-cols-4 gap-4 bg-white rounded-md shadow-md border-2 px-5 py-5">
                    <div class="flex items-center bg-white border-2 p-5 rounded-md shadow-md">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                            <path fill="none" d="M0 0h24v24H0z"></path>
                            <path
            ...
            <div class="px-5" id="information" data-tab-content="">
                <div class="bg-white rounded-xl py-4 px-6 border-b-4 border-darkred-50 mb-4">
                    ...
                    <div>
                        ...
                        <div class="mt-10 px-8">
                            <div class="flex w-full pb-3">
                                <p class="capitalize w-3/12">First name:</p>
                                <p class="capitalize">john</p>
                            </div>
                            <div class="flex w-full pb-3">
                                <p class="w-3/12 capitalize">last name:</p>
                                <p class="capitalize">doe</p>
                            </div>
                            <div class="flex w-full pb-3">
                                <p class="w-3/12 capitalize">contact number:</p>
                                <p class="capitalize">01633137586</p>
                            </div>
                            <div class="flex w-full pb-3">
                                <p class="w-3/12 capitalize">gender:</p>
                                <p class="capitalize">male</p>
                            </div>
                    ...
                    <div class="mt-8">
                        ...
                        <div class="mt-10 px-8">
                            <div class="flex w-full pb-3">
                                ...
                                <p class="capitalize">john@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="px-5" id="orders" data-tab-content="">
                <div class="bg-white rounded-xl py-4 px-6 border-b-4 border-darkred-50 mb-4">
            ...
            <div id="reviews" data-tab-content="">
                <div class="bg-white rounded-xl py-4 px-6 border-b-4 border-darkred-50 mb-4">
                    <h1 class="capitalize">review list</h1>
                </div>
                <div class="bg-white border-2 rounded-md shadow-md px-5 py-3">
                    <div>
                        <div class="flex items-center justify-between">
                            <div class="flex justify-start items-center w-full space-x-2">
                                ...
                                <h1 class="capitalize font-semibold text-2xl">review list</h1>
                            </div>
                        </div>
                        <p class="border-b-4 border-darkred-50 ml-10 w-2/12 pt-1"></p>
            ...
            <div class="px-5" id="password" data-tab-content="">
                <div class="bg-white rounded-xl py-4 px-6 border-b-4 border-darkred-50 mb-4">
                    <h1 class="capitalize">change your password</h1>
                </div>
                <div class="bg-white border-2 rounded-md shadow-md px-5 py-3">
                    <div>
                        <div class="pb-3">
            ...
            <div id="wishlist" data-tab-content="">
                <div class="bg-white rounded-xl py-4 px-6 border-b-4 border-darkred-50 mb-4">
                    <h1 class="capitalize">wishlist</h1>
                </div>
                <div class="bg-white border-2 rounded-md shadow-md px-5 py-3">
                    <div>
                        <div class="flex items-center justify-between">
                            <div class="flex justify-start items-center w-full space-x-2">
                                ...
                                <h1 class="capitalize font-semibold text-2xl">wishlist</h1>
                            </div>
                        </div>
                        <p class="border-b-4 border-darkred-50 ml-10 w-1/12 pt-1"></p>
            ...
            <div class="px-5" id="coupon" data-tab-content="">
                <div class="bg-white rounded-xl py-4 px-6 border-b-4 border-darkred-50 mb-4">
                    <h1 class="capitalize">coupon</h1>
                </div>
                <div class="bg-white border-2 rounded-md shadow-md px-5 py-3">
                    <div>
                        <div class="flex items-center justify-between">
                            <div class="flex justify-start items-center w-full space-x-2">
                                ...
                                <h1 class="capitalize font-semibold text-2xl">coupon</h1>
                            </div>
                        </div>
                        <p class="border-b-4 border-darkred-50 ml-10 w-1/12 pt-1"></p>
            ...
            <div class="px-5" id="user_request" data-tab-content="">
                <div class="bg-white rounded-xl py-4 px-6 border-b-4 border-darkred-50 mb-4">
                    <h1 class="capitalize">user request product</h1>
                </div>
                <div class="bg-white border-2 rounded-md shadow-md px-5 py-3">
                    <div>
                        <div class="flex items-center justify-between">
                            <div class="flex justify-start items-center w-full space-x-2">
                                ...
                                <h1 class="capitalize font-semibold text-2xl">user request product</h1>
                            </div>
                            <div class="w-3/12">
                                <button
                                    class="capitalize text-sm px-3 py-2 font-semibold cursor-pointer bg-darkred-100 text-white"
            ...
            <div id="report" data-tab-content="">
                <div class="bg-white rounded-xl py-4 px-6 border-b-4 border-darkred-50 mb-4">
                    <h1 class="capitalize">report issue</h1>
                </div>
                <div class="bg-white border-2 rounded-md shadow-md px-5 py-3">
                    <div>
                        <div class="flex items-center justify-between">
                            <div class="flex justify-start items-center w-full space-x-2">
                                ...
                                <h1 class="capitalize font-semibold text-2xl">report issue</h1>
                            </div>
                        </div>
                        <p class="border-b-4 border-darkred-50 ml-10 w-2/12 pt-1"></p>
